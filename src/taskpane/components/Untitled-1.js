const { TextField, Toggle, Fabric: FabricComponent, Announced, DetailsList, DetailsListLayoutMode, Selection, SelectionMode, IColumn, MarqueeSelection, mergeStyleSets, TooltipHost, initializeIcons } = window.Fabric;
...
const DetailsListDocumentsExampleWrapper = () => <FabricComponent><DetailsListDocumentsExample /></FabricComponent>;
